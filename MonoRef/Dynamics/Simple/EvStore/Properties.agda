...
val⟶ᶜ⊥ () (cong (ξ-:=ₗ _ _ _) _)
val⟶ᶜ⊥ () (cong (ξ-:=ᵣ _ _ _) _)
...
val⟶ᶜ⊥ () (cong-error (ξ-! _ _))
val⟶ᶜ⊥ () (cong-error (ξ-:=ₛₗ _ _))
val⟶ᶜ⊥ () (cong-error (ξ-:=ₛᵣ _ _))
val⟶ᶜ⊥ () (cong-error (ξ-:=ₗ _ _ _))
val⟶ᶜ⊥ () (cong-error (ξ-:=ᵣ _ _ _))
...
scv⟶ᶜ⟹cv' (v⇑ ()) _ (cong (ξ-! _ _) _)
scv⟶ᶜ⟹cv' (v⇑ ()) _ (cong (ξ-:=ₛₗ _ _) _)
scv⟶ᶜ⟹cv' (v⇑ ()) _ (cong (ξ-:=ₛᵣ _ _) _)
scv⟶ᶜ⟹cv' (v⇑ ()) _ (cong (ξ-:=ₗ _ _ _) _)
scv⟶ᶜ⟹cv' (v⇑ ()) _ (cong (ξ-:=ᵣ _ _ _) _)
