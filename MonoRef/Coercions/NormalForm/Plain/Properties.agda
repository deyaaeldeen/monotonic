...
A⇒RefB-coercion⇒Active (final (middle (id x))) = A-final (A-middle (A-id x))
...
⋆Acoercion⇒Active iA id⋆ = A-id⋆
⋆Acoercion⇒Active iA (prjSeq iA₁ x) = A-prjSeq iA₁ x
⋆Acoercion⇒Active () (final (injSeq iB x))
⋆Acoercion⇒Active iA (final (middle (id x))) = A-final (A-middle (A-id x))
