...
compose-final-height (middle fail) (prjSeq A c) {suc _} {s≤s _} = m≤m⊔n 1 (‖ A ‖ʰᵢₜ ⊔ ‖ c ‖ʰᶠ)
...
...  | l | r =
  begin
    ...
    suc (‖ c ‖ʰ ⊔ ‖ d ‖ʰ ⊔ (‖ c' ‖ʰ ⊔ ‖ d' ‖ʰ))
  ∎
compose-middle-height c@(fun _ _) fail {suc _} = m≤m+n 1 _
...
...  | l | r =
  begin
    ...
    suc (‖ c ‖ʰ ⊔ ‖ d ‖ʰ ⊔ (‖ c' ‖ʰ ⊔ ‖ d' ‖ʰ))
  ∎
compose-middle-height c@(prod _ _) fail {suc _} = m≤m+n 1 _
